...
export async function continueConversation(history: Message[]) {
  ...
  const { text, toolResults } = await generateText({
    ...
    system: "You are a friendly quizz generator!",
    messages: history,
    tools: {
      showWeather: {
        description: "quizz about something",
        parameters: z.object({
          question: z
            .string()
            .describe("The question about the subject the user chose"),
        ...
        execute: async ({ question, wronganswer, correctAnswer }) => {
          ...
          stream.done(<Test correctAnswer={correct} question={que} wronganswer={wrong} />); // [!code highlight]
